...
namespace Host.Quickstart.Account
{
    ...
    public class ExternalController : Controller
    {
        ...
        public async Task<IActionResult> Callback()
        {
            ...
            // issue authentication cookie for user we must issue the cookie maually, and can't use
            // the SignInManager because it doesn't expose an API to issue additional claims from the
            // login workflow
